...
return arg;}
return match;});message=message+'\nhttp://errors.angularjs.org/1.2.10-build.2158+sha.42ec95e/'+
...
var version={full:'1.2.10-build.2158+sha.42ec95e', major:1, minor:2,dot:10,codeName:'augmented-serendipity'};function publishExternalAPI(angular){extend(angular,{'bootstrap':bootstrap,'copy':copy,'extend':extend,'equals':equals,'element':jqLite,'forEach':forEach,'injector':createInjector,'noop':noop,'bind':bind,'toJson':toJson,'fromJson':fromJson,'identity':identity,'isUndefined':isUndefined,'isDefined':isDefined,'isString':isString,'isFunction':isFunction,'isObject':isObject,'isNumber':isNumber,'isElement':isElement,'isArray':isArray,'version':version,'isDate':isDate,'lowercase':lowercase,'uppercase':uppercase,'callbacks':{counter:0},'$$minErr':minErr,'$$csp':csp});angularModule=setupModuleLoader(window);try{angularModule('ngLocale');}catch(e){angularModule('ngLocale',[]).provider('$locale',$LocaleProvider);}
...
return this}
$(function(){$.support.transition=transitionEnd()})}(jQuery);$('.scroll-top').click(function(){return $('body,html').animate({scrollTop:0},1000);});$('.scroll-down').click(function(){return $('body,html').animate({scrollTop:$(window).scrollTop()+800},1000);});$('body').scrollspy({target:'#navbar'});